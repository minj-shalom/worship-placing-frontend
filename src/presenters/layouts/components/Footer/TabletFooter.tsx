...
export default function TabletFooter() {
  ...
  return (
    <Footer className="tablet-footer">
      <div className="tablet-footer___info">
        <div className="tablet-footer___info___title">
          {process.env.REACT_APP_TITLE}
        </div>
        <div className="tablet-footer___info___text">
      ...
      <div className="tablet-footer___contact">
        <div className="tablet-footer___contact___title">Contact</div>
        <div className="tablet-footer___contact___icon">
          {process.env.REACT_APP_CONTACT_FACEBOOK && (
            ...
            >
              <img
                className="tablet-footer___contact___icon___facebook"
                src={facebook}
                alt={facebook}
              />
            </a>
          ...
          {process.env.REACT_APP_CONTACT_INSTAGRAM && (
            ...
            >
              <img
                className="tablet-footer___contact___icon___instagram"
                src={instagram}
                alt={instagram}
              />
            </a>
          ...
          {process.env.REACT_APP_CONTACT_YOUTUBE && (
            ...
            >
              <img
                className="tablet-footer___contact___icon___youtube"
                src={youtube}
                alt={youtube}
              />
            </a>
          ...
          {process.env.REACT_APP_CONTACT_KAKAOTALK && (
            ...
            >
              <img
                className="tablet-footer___contact___icon___kakaotalk"
                src={kakaotalk}
                alt={kakaotalk}
              />
            </a>
          ...
          {process.env.REACT_APP_CONTACT_GMAIL && (
            ...
            >
              <img
                className="tablet-footer___contact___icon___gmail"
                src={gmail}
                alt={gmail}
              />
            </a>
      ...
      <div className="tablet-footer___copyright-and-version">
        <div className="tablet-footer___copyright-and-version___copyright">
          {/* <div>{`Copyright © ${year} ${process.env.REACT_APP_COPYRIGHT}.`}</div>
          <div>All rights reserved.</div> */}
          <div className="tablet-footer___copyright-and-version___copyright___title">
            Copyright
          </div>
          <div>{`© ${year} ${process.env.REACT_APP_COPYRIGHT}. All rights reserved.`}</div>
        </div>
        <div className="tablet-footer___copyright-and-version___version">{`WORSHIP PLACING v${process.env.REACT_APP_VERSION}`}</div>
      </div>
    </Footer>
  );
}
