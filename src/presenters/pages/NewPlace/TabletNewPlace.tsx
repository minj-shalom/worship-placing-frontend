...
import "./TabletNewPlace.scss";

export default function TabletNewPlace() {
  const { Step } = Steps;
  const { Option } = Select;
  ...
  return (
    <div className="tablet-new-place">
      <div className="tablet-new-place___header">
        <div className="page-title">관리</div>
        <div className="tablet-new-place___header___title">
          유스예배 자리 생성
        </div>
        <div className="tablet-new-place___header___description">
          이곳에서 유스예배 자리를 생성하실 수 있습니다.
        </div>
      </div>
      <Divider />
      <div className="tablet-new-place___body">
        <div className="tablet-new-place___body___top">{getStep()}</div>
        <Divider className="tablet-new-place___body___divider" />
        <div
          className="tablet-new-place___body___bottom"
