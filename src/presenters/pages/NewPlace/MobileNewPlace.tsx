...
import "./MobileNewPlace.scss";

export default function MobileNewPlace() {
  const { Step } = Steps;
  const { Option } = Select;
      ...
      <>
        {step === 0 && (
          ...
          >
            ...
            <Form.Item
              className="mobile-form-margin-bottom"
              name="description"
              label="설명"
            >
              <TextArea
        ...
        {step === 1 && (
          <>
            <div className="seat-num-controll mobile-control-margin-bottom">
              <div className="seat-num-controll___text mobile-description">
                예배 자리수 직접 지정
              </div>
              <Switch
  ...
  return (
    <div className="mobile-new-place">
      <div className="mobile-new-place___header">
        <div className="page-title">관리</div>
        <div className="mobile-new-place___header___title">
          유스예배 자리 생성
        </div>
        <div className="mobile-new-place___header___description">
          이곳에서 유스예배 자리를 생성하실 수 있습니다.
        </div>
      </div>
      <Divider />
      <div className="mobile-new-place___body">
        <div className="mobile-new-place___body___top">{getStep()}</div>
        <Divider className="mobile-new-place___body___divider" />
        <div
          className="mobile-new-place___body___bottom"
          style={{ width: step === 2 ? "100%" : "100%" }}
        >
          {useGetForm()}
        </div>
      </div>
