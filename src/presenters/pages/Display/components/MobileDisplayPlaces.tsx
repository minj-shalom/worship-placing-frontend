...
interface MobileDisplayPlacesProps {
  worshipPlace: WorshipPlace;
}

export default function MobileDisplayPlaces({
  worshipPlace,
}: MobileDisplayPlacesProps) {
    ...
    <div className="mobile-display">
      <div className="mobile-display___header">
        <div className="mobile-display___header___content">
          <div className="mobile-display___header___content___top">
          ...
          <div className="mobile-display___header___content___bottom">
      ...
      <Divider />
      <div className="mobile-display___controll">
        <div className="title">{displayMode ? "좌석 현황" : "좌석표"}</div>
        <div className="mobile-display___controll___action">
          <div className="mobile-display___controll___action___text mobile-description">
            디스플레이 모드
          </div>
          <Switch
            className="mobile-display___controll___action___switch"
            onChange={onChange}
            defaultChecked={true}
          />
        </div>
